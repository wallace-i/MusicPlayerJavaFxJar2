...
public class Utils {
    ...
    public static String getExeDirPath() { return System.getProperty("user.dir"); }

    public static void clearSerializedFiles() throws IOException {
        PrintWriter clearTrackList = new PrintWriter(ResourceFiles.getTrackListFile());
        clearTrackList.close();

        PrintWriter clearArtistList = new PrintWriter(ResourceFiles.getArtistListFile());
        clearArtistList.close();

        PrintWriter clearPlaylists = new PrintWriter(ResourceFiles.getPlaylistsFile());
