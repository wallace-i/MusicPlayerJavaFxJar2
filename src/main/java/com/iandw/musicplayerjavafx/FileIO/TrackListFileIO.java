...
public class TrackListFileIO {
    ...
    public static ObservableList<TrackMetadata> inputTrackObservableList() {
        ...
        try (FileInputStream in = new FileInputStream(ResourceFiles.getTrackListFile())) {
            // Read from file
     ...
     */
    public static void outputTrackObservableList(ObservableList<TrackMetadata> trackMetadataObservableList) {
        ...
        try (FileOutputStream out = new FileOutputStream(ResourceFiles.getTrackListFile())) {
